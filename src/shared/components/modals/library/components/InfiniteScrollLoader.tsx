...
export function FixedTopLeftLoader({ 
  ...
  return (
    <div className={`fixed top-4 left-4 z-[9999] bg-gray-800/90 backdrop-blur-sm rounded-lg px-3 py-2 flex items-center gap-2 shadow-lg pointer-events-none ${className}`}>
